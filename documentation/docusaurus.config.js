    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/blakemoran14/documentation-test',
        },
        theme: {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/blakemoran14/Documentation-Test',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Documentation Example. Built with Docusaurus.`,
      },
      prism: {
